...
Pong::Game::Game(Engine& engine) : engine{ engine }, emitBallPosition{}, pointsPlayer{0}, pointsEnemy{0} {}
...
void Pong::Game::load() {
	...
	new Pong::Ball{ *this, emitBallPosition };
	new Pong::Opponent{ *this, emitBallPosition };
}